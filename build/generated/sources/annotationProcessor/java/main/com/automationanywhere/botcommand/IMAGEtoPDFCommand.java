...
public final class IMAGEtoPDFCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(IMAGEtoPDFCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    IMAGEtoPDF command = new IMAGEtoPDF();
