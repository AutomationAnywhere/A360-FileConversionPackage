...
public final class XLSXtoCSVCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(XLSXtoCSVCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    XLSXtoCSV command = new XLSXtoCSV();
    ...
    if(convertedParameters.containsKey("inputFile")) {
      ...
      if (lastIndxDot == -1 || lastIndxDot >= filePath.length()) {
        throw new BotCommandException(MESSAGES_GENERIC.getString("generic.validation.FileExtension","inputFile","xlsx"));
      }
