...
public final class PPTXtoPDFCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(PPTXtoPDFCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    PPTXtoPDF command = new PPTXtoPDF();
