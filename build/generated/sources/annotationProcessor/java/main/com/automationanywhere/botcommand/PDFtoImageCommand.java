...
public final class PDFtoImageCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(PDFtoImageCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    PDFtoImage command = new PDFtoImage();
