...
public final class PPTXtoImageCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(PPTXtoImageCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    PPTXtoImage command = new PPTXtoImage();
    ...
    if(convertedParameters.containsKey("inputFile")) {
      ...
      if (lastIndxDot == -1 || lastIndxDot >= filePath.length()) {
        throw new BotCommandException(MESSAGES_GENERIC.getString("generic.validation.FileExtension","inputFile","pptx"));
      }
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("inputFile"),(String)convertedParameters.get("outputType"),(String)convertedParameters.get("outputPath")));
