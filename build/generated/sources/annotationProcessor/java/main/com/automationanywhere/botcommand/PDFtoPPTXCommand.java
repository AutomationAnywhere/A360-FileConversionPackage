...
public final class PDFtoPPTXCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(PDFtoPPTXCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    PDFtoPPTX command = new PDFtoPPTX();
